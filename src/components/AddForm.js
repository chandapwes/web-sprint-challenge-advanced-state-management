...
import { fetchFail, addError, addSmurf } from './../actions/index';
...
const AddForm = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        addSmurf(state.name, state.position, state.nickname, state.summary)
    }
...
export default connect({ fetchFail, addError, addSmurf })(AddForm);
